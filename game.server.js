...
*/
    ...
    game_server._onMessage = function(client,message) {
		...
		console.log('onMessage',message_parts);
        var other_client =
    ...
    game_server.onInput = function(client, parts) {
		...
		console.log('onInput:input_commands',input_commands);
		console.log('onInput:input_time',input_time);
		console.log('onInput:input_seq',input_seq);
    ...
    game_server.findGame = function(player) {
		...
		console.log('player findGame:',player);
